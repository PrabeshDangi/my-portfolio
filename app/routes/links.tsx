        ...
        {links.map((link) => (
          ...
          >
            ...
            <div className="relative overflow-hidden w-full  text-center h-6">
              <span className="text-sm md:text-base font-medium text-foreground absolute inset-0 w-full transition-transform duration-300 group-hover:-translate-y-full">
                {link.platform}
              </span>
              <span className="text-sm md:text-base font-medium text-foreground absolute w-full inset-0 transition-transform duration-300 translate-y-full group-hover:translate-y-0">
                {link.platform}
              </span>
            </div>
          </Link>
